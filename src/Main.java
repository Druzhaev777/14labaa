...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            while (true) {
                if ("save".equals(st1)) {
                    try (ObjectOutputStream fww = new ObjectOutputStream(new FileOutputStream("d//lb14.txt"))) {
            ...
            String st = in.next();
            if ("upload".equals(st)) {
                try (ObjectInputStream pt = new ObjectInputStream(new FileInputStream("d//lb14.txt"))) {
